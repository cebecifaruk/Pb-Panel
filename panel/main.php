...
<html lang="en">
	<head>
		<iframe align="right" src="launcher.php" width="463" height="1040" scrolling="yes" frameborder="0" style="background-color:<?php $background_color?> " ></iframe>
